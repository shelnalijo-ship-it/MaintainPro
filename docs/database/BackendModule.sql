...
START TRANSACTION;
DROP INDEX "IX_MachineAssignmentHistories_MachineId";

ALTER TABLE "Users" ADD "SecurityStamp" uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

ALTER TABLE "Users" ADD "Version" uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

ALTER TABLE "Machines" ADD "Version" uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
...
CREATE UNIQUE INDEX "IX_MachineAssignmentHistories_MachineId" ON "MachineAssignmentHistories" ("MachineId") WHERE "EffectiveTo" IS NULL;
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260914202309_IdentityAndMachineManagement', '10.0.12');
